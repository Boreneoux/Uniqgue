...
<footer class="bg-[#3C4F77] w-full py-8 mt-auto">
    <div class="flex justify-center">
        <a href="/" class="font-normal text-2xl text-white mb-4">UNIQGUE</a>
        <!-- Ini buat sosmed -->
    </div>
    <div class="flex items-center justify-center mb-2">
        ...
        <a href="https://www.instagram.com/uniqgue_" class="mx-2">
    ...
    <p class="text-white font-thin text-sm justify-center flex">
